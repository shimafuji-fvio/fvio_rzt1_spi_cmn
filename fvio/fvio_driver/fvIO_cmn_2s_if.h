 ...
 ***************************************************************************/
#ifndef __FVIO_CMN_2S_IF_H
#define __FVIO_CMN_2S_IF_H

#include "platform.h"

//汎用fvIOレジスタ
struct st_fvio_cmn_2s_out{
...
typedef struct {
    struct st_fvio_cmn_2s_out *reg;   //fvIO レジスタ構造体
    unsigned char *fifo;              //FIFOレジスタ
} ST_FVIO_CMN_S2_REGIF;

//TRG reg
#define FVIO_CMN_2S_REG_TRG_FCLR        (0x80)
#define FVIO_CMN_2S_REG_TRG_SYNC        (0x08)
#define FVIO_CMN_2S_REG_TRG_INT         (0x04)
#define FVIO_CMN_2S_REG_TRG_REP         (0x02)
#define FVIO_CMN_2S_REG_TRG_TRG         (0x01)

//STAT reg
#define FVIO_CMN_2S_REG_STAT_FERR       (0x80)
#define FVIO_CMN_2S_REG_STAT_TRDY       (0x01)
